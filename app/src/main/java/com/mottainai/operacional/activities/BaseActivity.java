...
public abstract class BaseActivity extends AppCompatActivity {
     ...
     *
     * As abas usam os mesmos ids do nav_graph ({@code homeFragment},
     * {@code productsListFragment}, {@code scannerFragment}, {@code iaAlertsFragment},
     * {@code profileFragment}, {@code configFragment}), para que uma tela do
     * protótipo e o fragmento equivalente do app respondam pelo mesmo id.
     */
    public enum Journey {
        ...
        final Class<?> last;
        /** O scanner é o mesmo nas três jornadas. */
        final Class<?> scanner = ScannerActivity.class;
    ...
    protected void setupBottomNav(Journey journey, @IdRes int selectedItemId) {
        ...
        bottomNav.setOnItemSelectedListener(item -> {
            ...
            if (id == R.id.homeFragment) {
                target = journey.home;
            } else if (id == R.id.productsListFragment) {
                target = journey.products;
            } else if (id == R.id.scannerFragment) {
                target = journey.scanner;
            } else if (id == R.id.iaAlertsFragment) {
                target = journey.ai;
            } else if (id == R.id.profileFragment || id == R.id.configFragment) {
                target = journey.last;
            }
